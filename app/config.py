...
class Settings:
    def __init__(self):
        self.OPENAI_API_KEY = os.getenv('OPENAI_API_KEY', 'ysk-proj-Lzu0jlXDzdXbqMhRP6ywsz_WXSYqVe117YLuLyHLZZ9ZWjjooa5PFfJV_DcJfxvijSnDTR59rtT3BlbkFJmxKI9Gfh5sLL9Q8yCMgIRIXR3qg_5ysreaZ_olyjCtwdwPrAP_zRUip3RVSOIyjx8OkgpqFhwA')
